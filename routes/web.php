...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/bookings/{id}/cancel', [BookingController::class, 'cancel'])->name('bookings.cancel.main');

    // Booking process under property
    Route::prefix('property/{id}')->group(function () {
        ...
        Route::get('/process-booking', [BookingController::class, 'processBooking'])->name('bookings.process.get');
        Route::post('/process-booking', [BookingController::class, 'processBooking'])->name('bookings.process.post');
    ...
    Route::prefix('host')->group(function () {
        ...
        // Host Property Edit
        Route::prefix('property/{property}/view-edit')->group(function () {
